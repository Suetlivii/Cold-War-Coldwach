...
FixedWingF10CommandController:AddMenuCommandForGroupsWithPrefix("FW", nil, "Show current task")
--For rotary wing (RW) aircraft
RotaryWingF10CommandController = GroupPrefixF10CommandController:New()
RotaryWingF10CommandController:AddMenuCommandForGroupsWithPrefix("RW", nil, "Show current task")
